...
//#define BALL_WHITE_Y_VALUE_MIN 244
//#define BALL_WHITE_Y_VALUE_MAX 255
//#define BALL_WHITE_U_VALUE_MIN 244
//#define BALL_WHITE_U_VALUE_MAX 255
//#define BALL_WHITE_V_VALUE_MIN 244
//#define BALL_WHITE_V_VALUE_MAX 255
//
//#define GRAY_Y_VALUE_MIN 159
//#define GRAY_Y_VALUE_MAX 206
//#define GRAY_U_VALUE_MIN 159
//#define GRAY_U_VALUE_MAX 206
//#define GRAY_V_VALUE_MIN 159
//#define GRAY_V_VALUE_MAX 206
//
//#define LINE_WHITE_Y_VALUE_MIN 244
//#define LINE_WHITE_Y_VALUE_MAX 255
//#define LINE_WHITE_U_VALUE_MIN 244
//#define LINE_WHITE_U_VALUE_MAX 255
//#define LINE_WHITE_V_VALUE_MIN 244
//#define LINE_WHITE_V_VALUE_MAX 255
//
//#define GREEN_Y_VALUE_MIN 12
//#define GREEN_Y_VALUE_MAX 73
//#define GREEN_U_VALUE_MIN 91
//#define GREEN_U_VALUE_MAX 154
//#define GREEN_V_VALUE_MIN 16
//#define GREEN_V_VALUE_MAX 77
...
int main()
{
	...
	green_value[2][0]=16;
	green_value[2][1]=77;
	cout<<"color threshold"<<green_value[0][0]<<endl;
	...
	//read image and create a table to store it
	Mat src=imread("4.jpg");
	unsigned int rownumber=src.rows;
	unsigned int colnumber=src.cols;
	//int imagetable[600][425][3];
	for(int i=0;i<rownumber;i++)
	{
		for(int j=0;j<colnumber;j++)
		{
			imagetable.x[i][j]=int(src.at<Vec3b>(i,j)[0]);
			imagetable.y[i][j]=int(src.at<Vec3b>(i,j)[1]);
			imagetable.z[i][j]=int(src.at<Vec3b>(i,j)[2]);
		}
	}

	cout<<"imagetable element"<<imagetable.x[1][1]<<endl;
	...
	{
			particle_position[i][0]=rand()%(rownumber-2*row_boundary)+row_boundary;
			particle_position[i][1]=rand()%(colnumber-2*col_boundary)+col_boundary;
	}
